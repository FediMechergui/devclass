    ...
    <main className="min-h-screen parchment-grain">
      ...
      <section className="relative min-h-[88vh] flex flex-col items-center justify-center px-6 pt-20 pb-12">
        ...
        <p className="max-w-reading text-center text-parchment-200 text-lg leading-relaxed font-body">
          A 33-question self-assessment for software engineers. Nine pillars.
          Ten archetypes. One uncomfortable mirror.
          <br />
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        ...
        <p className="text-center text-parchment-600 max-w-reading mx-auto mb-16">
          Not personality types. Not "soft" labels. Each archetype is a distinct
          vector through nine engineering virtues — most of which you already
      ...
      <section className="px-6 py-24 bg-ink-elevated/40">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-parchment-600 max-w-reading mx-auto mb-16">
            Every question maps to one of these. Together they form the vector
            that defines your class — and, more importantly, the directions you
            can grow.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-sm text-parchment-400">
              Your dominant archetype, plus any secondary classes if you
              straddle two.
            </p>
          </div>
          <div>
            <div className="font-display text-2xl text-teal-bright mb-2">
              A character sheet
            </div>
            <p className="text-sm text-parchment-400">
              Nine-axis radar, your three strongest pillars, and the three with
              most room to grow.
            </p>
          </div>
          <div>
            <div className="font-display text-2xl gold-shimmer mb-2">
              A four-week plan
            </div>
            <p className="text-sm text-parchment-400">
              AI-generated habits and reading, in the voice of your archetype,
              calibrated to your weakest pillars.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-24 bg-ink-elevated/40">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-parchment-600 mb-8 text-sm">
            Devclass is opinionated synthesis, not novel research. It stands on
            the shoulders of writers who have spent decades trying to name what
            makes engineers good. Some of the work that directly shaped this:
          </p>
          <ul className="space-y-4 text-sm text-parchment-200">
            <li>
              &ldquo;<em>Are You A Good Programmer?</em>&rdquo; &mdash;{" "}
              <span className="text-gold">Manware</span>, May 2026. The catalyst
              question that started this project.
            </li>
            <li>
              &ldquo;<em>A Philosophy of Software Design</em>&rdquo; &mdash;{" "}
              <span className="text-gold">John Ousterhout</span>. For the
              framing of complexity as the central problem of software, and
              modules as deep vs. shallow.
            </li>
            <li>
              &ldquo;<em>The Pragmatic Programmer</em>&rdquo; &mdash;{" "}
              <span className="text-gold">Hunt &amp; Thomas</span>. For the
              working definition of <em>care</em> in engineering practice.
            </li>
            <li>
              &ldquo;<em>Designing Data-Intensive Applications</em>&rdquo;
              &mdash; <span className="text-gold">Martin Kleppmann</span>. For
              showing what Domain Mastery looks like when fully expressed.
            </li>
            <li>
              &ldquo;<em>Programming as Theory Building</em>&rdquo; &mdash;{" "}
              <span className="text-gold">Peter Naur</span>, 1985. The reason
              Engineering Integrity exists as a separate pillar.
            </li>
            <li>
              &ldquo;<em>No Silver Bullet</em>&rdquo; &mdash;{" "}
              <span className="text-gold">Fred Brooks</span>, 1986. Still the
              calibration check on every claim of methodology.
            </li>
            <li>
              &ldquo;<em>Big Five</em>&rdquo; personality research (Costa &amp;
              McCrae) &mdash; for the statistical machinery (cosine similarity,
              vector space classification) we adapt for archetype assignment.
            </li>
          </ul>
          <p className="text-xs text-parchment-600 mt-8 italic">
            We deliberately do <em>not</em> claim psychometric validity. This is
            a self-reflection tool, not a personality test.{" "}
            <Link href="/methodology" className="text-gold underline">
